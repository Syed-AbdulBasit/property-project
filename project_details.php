...
if(isset($_GET['View_pro'])){
       ...
       $project= $sql->query("SELECT * FROM project WHERE ID= $id")or die ($sql->error);
      ...
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-end">
          <div class="col-md-9 ftco-animate pb-5">
          	<p class="breadcrumbs"><span class="mr-2"><a href="index.html">Home <i class="fa fa-chevron-right"></i></a></span> <span class="mr-2"><a href="project.php">Project <i class="fa fa-chevron-right"></i></a></span> <span>Project Details<i class="fa fa-chevron-right"></i></span></p>
        ...
        <div class="row">
          <div class="col-md-12 ftco-animate">
           ...
           while ($row = $project->fetch_assoc()) { 
            ?>
          	<p>
              <img src="admin/uploads/files/<?php echo $row['P_Image'] ?>" alt="" class="img-fluid">
            </p>
            <h2 class="mb-3"><?= $row['P_Title']; ?></h2>
            <h4>Date:<?= $row['P_Date']; ?></h4>
            <h4>Description:</h4>
            <h5><?= $row['P_Description']; ?></h5>
            <h4>Details:</h4>
            <p><?= $row['P_Details']; ?></p>
<br>
                <a href="project.php" class="btn btn-outline-success btn-sm">Back</a>
            <?php } ?>
