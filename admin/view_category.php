...
<?php endif ?>
        ...
        include "includes/connection.php";
          $result= $sql->query("SELECT * FROM category")or die ($sql->error);
     ...
     <?php while ($row = $result->fetch_assoc()) { ?>
            <tr>
              ...
              <td><?= $row['Cat_Details']; ?></td>
               ...
               <td><a href="includes/process.php?delete_cat=<?php echo $row['Cat_ID']; ?>" onclick="return confirm('Are you sure you want to delete this item?');" class="btn btn-danger">
                Delete
              </a></td>
              <td><a href="category.php?edit_cat=<?php echo $row['Cat_ID']; ?>" onclick="return confirm('Are you sure you want to Edit this item?');" class="btn btn-info">
                Edit
              </a></td>
            </tr>
            <?php } ?>
