...
<?php endif ?>
     ...
     <?php while ($row = $result->fetch_assoc()) { ?>
            <tr>
              ...
              <td><img src="uploads/files/<?php echo $row['P_Image'] ?>" width="100px" height="100px"></td>

             
               <td><a href="includes/process.php?delete_project=<?php echo $row['ID']; ?>" onclick="return confirm('Are you sure you want to delete this item?');" class="btn btn-danger">
                Delete
              </a></td>
            </tr>
            <?php } ?>
