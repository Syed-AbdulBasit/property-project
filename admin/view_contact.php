...
<?php endif ?>
         ...
         include "includes/connection.php";
          $result= $sql->query("SELECT * FROM contact")or die ($sql->error);
     ...
     <?php while ($row = $result->fetch_assoc()) { ?>
            <tr>
              ...
              <td><?= $row['C_Message']; ?></td>
               ...
               <td><a href="includes/process.php?delete_contact=<?php echo $row['ID']; ?>" onclick="return confirm('Are you sure you want to delete this item?');" class="btn btn-danger">
                Delete
              </a></td>
            </tr>
            <?php } ?>
