     ...
     <?php while ($row = $result->fetch_assoc()) { ?>
            <tr>
              ...
              <td><img src="uploads/files/<?php echo $row['Image'] ?>" width="100px" height="100px"></td>
               ...
               <td><a href="includes/process.php?delete_about=<?php echo $row['ID']; ?>" onclick="return confirm('Are you sure you want to delete this item?');" class="btn btn-danger">
                Delete
              </a></td>
               <td><a href="about_us.php?edit_about=<?php echo $row['ID']; ?>" onclick="return confirm('Are you sure you want to Edit this item?');" class="btn btn-info">
                Edit
              </a></td>
            </tr>
            <?php } ?>
